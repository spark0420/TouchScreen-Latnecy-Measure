...
cap = cv2.VideoCapture('videos/fps60_green_blue_2.MOV')
...
while True and pixelsPerMetric != None:
    ...
    _, mask1 = cv2.threshold(odmask_blue, 100, 255, cv2.THRESH_BINARY)
    _, mask2 = cv2.threshold(odmask_green, 100, 255, cv2.THRESH_BINARY)
